import { Controller, Post, Body, UnauthorizedException, HttpCode, Get, Req, UseGuards    } from '@nestjs/common';
...
export class AuthController {
    ...
    @ApiResponse({ status: 200, description: 'User token refreshed', type: AuthResponseDto })
